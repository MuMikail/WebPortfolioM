...
const WORDS = ["SMK Pesat Student", "Rekayasa Perangkat Lunak"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/MuMikail" },
  { icon: Instagram, link: "https://www.instagram.com/qimik26/?next=%2Ffamkcyber%2F" }
];
